...
namespace backend.Migrations
{
    ...
    [Migration("20260831042849_numberOfSeatColumnInSubdivisionByYearTable")]
    partial class numberOfSeatColumnInSubdivisionByYearTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YOMA.Models.Tables.Book", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BOOK_CATEGORY_ID")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DAY_RENTAL_PRICE")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("YEAR_OF_PUBLICATION")
                        .HasColumnType("text");
                    ...
                    b.ToTable("Books", t =>
                        {
                            t.HasCheckConstraint("CK_QteRange", "\"QTE_TOTAL\" > 0");
                        });
                });

            modelBuilder.Entity("YOMA.Models.Tables.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.BookRental", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BookRentals", t =>
                        {
                            t.HasCheckConstraint("CK_Order_DateRange", "\"RETURN_DATE\" > \"RENTAL_DATE\"");
                        });
                });
            ...
            modelBuilder.Entity("YOMA.Models.Tables.BusRegistration", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.ForgotUserPassword", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CODE_GENERETED")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IS_VALIDED")
                        .HasColumnType("boolean");

                    b.HasKey("ID");

                    b.ToTable("ForgotUserPasswords");
                });
            ...
            modelBuilder.Entity("YOMA.Models.Tables.Language", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.Student", b =>
                {
                    ...
                    b.Property<int>("PARENT_1_TYPE_ID")
                        .HasColumnType("integer");

                    b.Property<int>("PARENT_2_ID")
                        .HasColumnType("integer");

                    b.Property<int>("PARENT_2_TYPE_ID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PARENT_1_TYPE_ID");

                    b.HasIndex("PARENT_2_ID");

                    b.HasIndex("PARENT_2_TYPE_ID");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.StudentBusStatusOfCare", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.StudentRegistration", b =>
                {
                    ...
                    b.Property<int>("STUDENT_BUS_STATUS_OF_CARE_ID")
                        .HasColumnType("integer");

                    b.Property<int>("STUDENT_ID")
                        .HasColumnType("integer");

                    b.Property<int>("STUDENT_SCHOOL_STATUS_OF_CARE_ID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("STUDENT_BUS_STATUS_OF_CARE_ID");

                    b.HasIndex("STUDENT_ID");

                    b.HasIndex("STUDENT_SCHOOL_STATUS_OF_CARE_ID");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.StudentSchoolStatusOfCare", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StudentSchoolStatusOfCares");
                });
            ...
            modelBuilder.Entity("YOMA.Models.Tables.UserEmail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.UserRole", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.UserType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.Book", b =>
                {
                    b.HasOne("YOMA.Models.Tables.BookCategory", "BOOK_CATEGORY")
                        .WithMany()
                        .HasForeignKey("BOOK_CATEGORY_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YOMA.Models.Tables.Language", "LANGUAGE")
                        .WithMany()
            ...
            modelBuilder.Entity("YOMA.Models.Tables.BookRental", b =>
                {
                    b.HasOne("YOMA.Models.Tables.Book", "BOOK")
                        .WithMany()
            ...
            modelBuilder.Entity("YOMA.Models.Tables.ExamClass", b =>
                {
                    b.HasOne("YOMA.Models.Tables.StudentRegistration", "STUDENT_REGISTRATION")
                        .WithMany()
                        .HasForeignKey("STUDENT_REGISTRATION_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("STUDENT_REGISTRATION");
                });
            ...
            modelBuilder.Entity("YOMA.Models.Tables.Student", b =>
                {
                    b.HasOne("YOMA.Models.Tables.Parent", "PARENT_1")
                        .WithMany()
                        .HasForeignKey("PARENT_1_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YOMA.Models.Tables.ParentType", "PARENT_1_TYPE")
                        .WithMany()
                        .HasForeignKey("PARENT_1_TYPE_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YOMA.Models.Tables.Parent", "PARENT_2")
                        .WithMany()
                        .HasForeignKey("PARENT_2_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YOMA.Models.Tables.ParentType", "PARENT_2_TYPE")
                        .WithMany()
                        .HasForeignKey("PARENT_2_TYPE_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PARENT_1_TYPE");

                    b.Navigation("PARENT_2");

                    b.Navigation("PARENT_2_TYPE");
            ...
            modelBuilder.Entity("YOMA.Models.Tables.StudentRegistration", b =>
                {
                    ...
                    b.HasOne("YOMA.Models.Tables.StudentBusStatusOfCare", "STUDENT_BUS_STATUS_OF_CARE")
                        .WithMany()
                        .HasForeignKey("STUDENT_BUS_STATUS_OF_CARE_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("YOMA.Models.Tables.StudentSchoolStatusOfCare", "STUDENT_SCHOOL_STATUS_OF_CARE")
                        .WithMany()
                        .HasForeignKey("STUDENT_SCHOOL_STATUS_OF_CARE_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("STUDENT_BUS_STATUS_OF_CARE");

                    b.Navigation("STUDENT_SCHOOL_STATUS_OF_CARE");
